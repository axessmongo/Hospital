        ...
        <div>
            ...
            <section className='container'>
                <div className='text-center py-4 my-4'>
                    ...
                    <img
                        src="https://images.ctfassets.net/u5xy9pirasv3/5Nb56bhJwIV0Vltg8MLUxZ/e2b1526099fe19cc9e8c1c9140c57378/About2.jpg"
            ...
            <section className='container'>
                <div className="row">
                    ...
                    <div className="col-md-7">
                        <h1> The Best Multi-speciality Hospital in Madurai</h1>
                        <p>Preethi Hospital in Madurai is one of the most prominent hospitals in Madurai for its innovative treatments and doctor-patient approach. The hospital offers a wide range of treatment procedures and has a dedicated doctor-patient support system in place. The hospital is open to any patient and the staff is available 24/7 to help the patients. It has a team of supportive and experienced professionals who work together to provide you with the best treatment available. If a picture is worth a thousand words, Preethi Hospital has been a living picture book for the city of Madurai. Over the years there have been innumerable people who have been saved from the clutches of death due to the hospital’s excellent work. This hospital has given hope to thousands of people and is a one-stop solution for the people of Madurai and its surroundings.</p>


                    </div>
                    <div className='text-center mb-4 mt-3 px-3'>
            ...
            <section className='container mt-5 p-5' style={{
                ...
                <div className="carding row gx-3 align-items-stretch mt-5">
                    <div className="col-md-3">
                        <div class="card-effect">
                            <div class="card-content-effect">
                                <img src="https://preethihospitals.com/wp-content/uploads/2023/02/examination.png" alt="" />
                    ...
                    <div className="col-md-3">
                        <div class="card-effect">
                            <div class="card-content-effect">
                                <img src="https://preethihospitals.com/wp-content/uploads/2023/04/yoga-pose.png" alt="" />
                                <h4 className="secondary-text">
                                    Nutrition and
                                    Dietetics
                                </h4>
                    ...
                    <div className="col-md-3">
                        <div class="card-effect">
                            <div class="card-content-effect">
                                <img src="https://preethihospitals.com/wp-content/uploads/2023/02/nursing-home-1.png" alt="" />
                                <h4 className="secondary-text">
                                    60+ Elder
                                    Care
                                </h4>
                ...
                <div>
                    <div>
                        <div className='text-center mb-5 px-3 '>
                            <h3 className='mt-4 pt-4'>OUR DEPARTMENTS</h3>
                            <h2 className='mt-4'>Higher Standards For All Your Healthcare</h2>
                                                ...
                                                <div class="content" style={{ padding: "18px" }}>
                                                    <div class="category-info">
                                                        ...
                                                        <div class="category-list">
                                                            <h4 className='text-center'>Emergency & Trauma Care
                                                            </h4>
                                                            <p>Prompt care in the golden hour through advanced care, resuscitation and early damage control surgical care.</p>
